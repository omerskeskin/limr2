...
src.global src.projection src.part  src.balanced src.merge 
src.gttreeh lemma.projection lemma.projection_helper 
lemma.decidable src.step lemma.step. 
From live_mpst.STLive Require Import src.lcontext src.wfltt src.assoc 
lemma.liveness_helpers lemma.soundness
lemma.completeness lemma.path_assoc lemma.multigrafting src.ltth src.path_props.
